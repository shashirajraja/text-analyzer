     ...
     <nav className={"navbar navbar-expand-lg " + (mode === "light" ? "bg-primary navbar-light" : "bg-dark navbar-dark")} >
        <div className={"container " + (mode === "light" ? "text-white" : "text-white") }>
            ...
            <div className="form-check form-switch" >
                <input className="form-check-input" data-onstyle="info" type="checkbox" role="switch" id="flexSwitchCheckDefault" onClick={props.toggleMode} defaultChecked={mode==="dark"}/>
